...
import { Mail, BookOpen, Calendar, Linkedin, Twitter, Facebook, Quote } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#FFFFFF' }}>
      ...
      >
        <div className="author-hero-container max-w-[1440px] mx-auto px-12">
          {/* Breadcrumb */}
          <div className={`author-breadcrumb mb-6 flex items-center justify-center gap-2 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
            <SafeLink
              href="/blog"
              style={{
                fontFamily: 'Inter, sans-serif',
          ...
          <div className={`author-header-content text-center max-w-[800px] mx-auto ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
            {/* Avatar */}
      ...
      {/* Author Info Block */}
      <section className="author-info-section info-section py-12" style={{ backgroundColor: '#FFFFFF' }}>
        <div className="author-info-container max-w-[1440px] mx-auto px-12">
          <div
            className={`author-info-card max-w-[900px] mx-auto rounded-[24px] p-10 ${isVisible ? 'animate-fade-up' : 'opacity-0'}`}
            style={{
      ...
      {/* Author Article Grid */}
      <section className="author-articles-section articles-section py-20" style={{ backgroundColor: '#F8FAFF' }}>
      ...
      {/* Author Pull Quote */}
      <section className="quote-section py-20" style={{ backgroundColor: '#FFFFFF' }}>
