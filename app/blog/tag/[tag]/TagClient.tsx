      ...
      >
        ...
        >
          <div className="tag-hero-container max-w-[1440px] mx-auto px-12">
            {/* Breadcrumb */}
            <div
              className={`tag-breadcrumb mb-6 flex items-center gap-2 ${
            ...
            <div
              className={`tag-header-content text-center max-w-[800px] mx-auto ${
                isVisible ? "animate-fade-in" : "opacity-0"
              }`}
            >
              <h1
        ...
        {/* Tag Description */}
        <section
          className="tag-description-section description-section py-12"
          style={{ backgroundColor: "#F8FAFF" }}
        >
          <div className="tag-description-container max-w-[1440px] mx-auto px-12">
            <div
              className={`tag-intro-text max-w-[860px] mx-auto text-center ${
        ...
        {/* Tagged Article Grid */}
        <section
          className="tag-article-grid-section article-grid-section py-20"
          style={{ backgroundColor: "#FFFFFF" }}
        >
