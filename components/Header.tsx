...
export function Header() {
  ...
  const navItems = [
    ...
    { label: 'Blog', href: '#/blog', path: '/blog', hasDropdown: true, dropdownType: 'blog' },
          ...
          <div className="max-w-[1440px] mx-auto h-full lg:px-12 md:px-8 px-6">
            <div className="flex items-center justify-between h-full">
              ...
              <div className="header-logo-group flex-shrink-0">
                <SafeLink to="/" className="inline-block">
                  <img 
                    src={logo} 
                    alt="Optichore" 
                ...
                <ul className="flex items-center gap-[34px]">
                  {navItems.map((item) => (
                    <li 
                      ...
                      onMouseEnter={() => {
                        if (item.dropdownType === 'services') setIsServicesOpen(true);
                        if (item.dropdownType === 'blog') setIsBlogOpen(true);
                      }}
                      onMouseLeave={() => {
                        if (item.dropdownType === 'services') setIsServicesOpen(false);
      ...
      {isTabletMenuOpen && (
        <div className="fixed inset-0 z-50 hidden md:block lg:hidden">
          ...
          >
                      ...
                      >
                        ...
                        <ChevronDown 
                          className={`w-5 h-5 transition-transform ${
                            (item.dropdownType === 'services' && tabletServicesExpanded) || 
            ...
            {/* Divider */}
            <div className="mx-6 border-t" style={{ borderColor: 'rgba(0, 0, 0, 0.06)' }} />
                  ...
                  {item.hasDropdown ? (
                    <>
                      ...
                      >
                        ...
                        <ChevronDown 
                          className={`w-5 h-5 transition-transform ${
                            (item.dropdownType === 'services' && mobileServicesExpanded) || 
