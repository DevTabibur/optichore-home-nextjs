  ...
  return (
    ...
    >
          ...
          <div className="footer-main-wrapper max-w-[1440px] mx-auto px-12">
            ...
            <div className="footer-5col-layout grid grid-cols-5 gap-20 mb-20">
              ...
              >
                ...
                >
                  Optichore is a UK-based IT and digital marketing company providing Meta advertising, web design, development, UI/UX, and software solutions to help brands grow.
                </p>
      ...
      <div className="lg:hidden">
        {/* ⭐ SECTION A — NEWSLETTER CTA (RESPONSIVE) */}
        <section className="newsletter-cta-responsive relative overflow-hidden">
          {/* Subtle Abstract Shapes */}
          <div 
            className="abstract-shapes-responsive absolute inset-0 pointer-events-none"
            style={{
              background: `radial-gradient(circle at 15% 25%, rgba(21, 21, 97, 0.04) 0%, transparent 50%),
                           radial-gradient(circle at 85% 75%, rgba(255, 0, 0, 0.03) 0%, transparent 50%)`,
              opacity: 0.6,
          ...
          <div className="newsletter-content-container-responsive max-w-[1440px] mx-auto md:px-8 px-6 md:py-28 py-20 relative z-10">
            {/* Centered Content */}
            <div className="text-center max-w-[920px] mx-auto md:space-y-10 space-y-8">
              {/* Heading - Responsive */}
              <h2 
                className="newsletter-heading-responsive md:text-[44px] text-[32px]"
                style={{
                  fontFamily: 'Inter, sans-serif',
                  fontWeight: 700,
                  color: '#151561',
              ...
              {/* Subtext - Responsive */}
              <p 
                className="newsletter-subtext-responsive md:text-[19px] text-[17px]"
                style={{
                  fontFamily: 'Inter, sans-serif',
                  fontWeight: 400,
                  color: '#505050',
              ...
              {/* Newsletter Input - Stacked on Mobile */}
              <form 
                onSubmit={handleSubmit} 
                className="newsletter-input-responsive flex flex-col md:gap-4 gap-3 pt-8 max-w-[640px] mx-auto"
              >
                ...
                <input
                  ...
                  onChange={(e) => setEmail(e.target.value)}
                  placeholder="Enter your email address"
                  className="newsletter-email-field-responsive w-full px-8 py-5"
                  required
                  style={{
                    fontFamily: 'Inter, sans-serif',
                    fontSize: '16px',
                ...
                <button
                  type="submit"
                  className="newsletter-cta-btn-responsive w-full px-11 py-5"
                  style={{
                    fontFamily: 'Inter, sans-serif',
                    fontSize: '16px',
                    fontWeight: 600,
        ...
        {/* ⭐ SECTION B — FOOTER (RESPONSIVE) */}
        <footer className="footer-responsive-section md:pt-20 pt-16 md:pb-16 pb-12" style={{ backgroundColor: '#F8F9FF' }}>
          <div className="footer-main-wrapper-responsive max-w-[1440px] mx-auto md:px-8 px-6">
            {/* Responsive Grid: Tablet 2x2, Mobile Single Column */}
            <div className="footer-responsive-grid grid md:grid-cols-2 grid-cols-1 md:gap-x-16 md:gap-y-12 gap-y-10 md:mb-16 mb-12">
              ...
              <div className="footer-brand-col-responsive md:space-y-7 space-y-6">
                ...
                <div className="footer-social-icons flex gap-3.5 pt-3">
                  <a
                    href="https://facebook.com"
                    className="footer-social-link-responsive"
                    aria-label="Facebook"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
              ...
              {/* Column 2 — Quick Links */}
              <div className="footer-quicklinks-col-responsive space-y-6">
                <h4 className="footer-col-heading-light">Quick Links</h4>
                <ul className="space-y-3.5">
                  {quickLinks.map((link, index) => (
                    <li key={index}>
              ...
              {/* Column 3 — Our Services */}
              <div className="footer-services-col-responsive space-y-6">
                <h4 className="footer-col-heading-light">Our Services</h4>
                <ul className="space-y-3.5">
                  {services.map((service, index) => (
                    <li key={index}>
              ...
              {/* Column 4 — Contact Information */}
              <div className="footer-contact-col-responsive space-y-6">
                <h4 className="footer-col-heading-light">Contact Information</h4>
                <div className="space-y-4">
                  {/* Email */}
                  <div className="flex items-start gap-3.5">
              ...
              {/* Column 5 — Working Hours (Mobile: appears last) */}
              <div className="footer-hours-col-responsive space-y-6 md:col-span-2">
                <h4 className="footer-col-heading-light">Working Hours</h4>
                <div className="space-y-3">
                  {/* Mon-Fri */}
                  <div>
            ...
            <div 
              className="footer-bottom-bar-responsive md:pt-10 pt-8"
              style={{
                borderTop: '1px solid rgba(0, 0, 0, 0.10)',
              }}
            >
              {/* Tablet: Horizontal | Mobile: Vertical Stack */}
              <div className="md:flex md:items-center md:justify-between md:space-y-0 space-y-6 text-center md:text-left">
                {/* Copyright */}
                <div 
                  style={{
                    fontFamily: 'Inter, sans-serif',
      ...
      <style>{`
        ...
        .newsletter-email-field-responsive::placeholder {
          color: rgba(0, 0, 0, 0.4);
        }

        .newsletter-email-field-light:focus,
        .newsletter-email-field-responsive:focus {
        ...
        .newsletter-cta-btn-responsive:hover {
