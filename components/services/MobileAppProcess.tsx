import { FileText, Palette, Code, TestTube, Rocket, Headphones } from 'lucide-react';

export function MobileAppProcess() {
  const steps = [
    { icon: <FileText className="w-7 h-7" />, title: 'Wireframes', description: 'Creating mobile app blueprints', number: '01' },
    { icon: <Palette className="w-7 h-7" />, title: 'UI/UX', description: 'Designing beautiful interfaces', number: '02' },
    { icon: <Code className="w-7 h-7" />, title: 'App Development', description: 'Building native functionality', number: '03' },
    { icon: <TestTube className="w-7 h-7" />, title: 'Testing', description: 'Quality assurance across devices', number: '04' },
    { icon: <Rocket className="w-7 h-7" />, title: 'Deployment', description: 'App store submission and launch', number: '05' },
    { icon: <Headphones className="w-7 h-7" />, title: 'Post-launch Support', description: 'Maintenance and updates', number: '06' },
  ];

  return (
    <section className="mobile-app-process-section w-full py-32" style={{ backgroundColor: '#FFFFFF' }}>
      <div className="max-w-[1440px] mx-auto px-12">
        <div className="text-center mb-20 space-y-4">
          ...
          <h2 style={{ fontFamily: 'Inter, sans-serif', fontSize: '48px', fontWeight: 700, color: '#151561', letterSpacing: '-0.02em', lineHeight: '1.2' }}>How We Build Mobile Apps</h2>
        </div>
