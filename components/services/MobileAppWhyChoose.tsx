...
export function MobileAppWhyChoose() {
  const reasons = [
    { icon: <Layers className="w-7 h-7" />, title: 'Modern mobile tech stack', description: 'Using React Native, Flutter, and native Swift/Kotlin for best results.' },
    { icon: <Zap className="w-7 h-7" />, title: 'Smooth animations', description: '60fps performance with fluid, delightful user interactions.' },
    { icon: <Shield className="w-7 h-7" />, title: 'Secure & optimized apps', description: 'Built with security best practices and optimized for performance.' },
  ];

  return (
    <section className="mobile-app-why-section w-full py-32" style={{ backgroundColor: '#F8FAFF' }}>
      <div className="max-w-[1440px] mx-auto px-12">
        <div className="text-center mb-20 space-y-4">
          ...
          <h2 style={{ fontFamily: 'Inter, sans-serif', fontSize: '48px', fontWeight: 700, color: '#151561', letterSpacing: '-0.02em', lineHeight: '1.2' }}>Our Mobile Excellence</h2>
        </div>
