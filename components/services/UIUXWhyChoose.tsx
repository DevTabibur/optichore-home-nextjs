import { BarChart3, Sparkles, Layers } from 'lucide-react';

export function UIUXWhyChoose() {
  const reasons = [
    { icon: <BarChart3 className="w-7 h-7" />, title: 'Data-backed UX', description: 'Every design decision is informed by user research and analytics.' },
    { icon: <Sparkles className="w-7 h-7" />, title: 'Premium interface design', description: 'Beautiful, modern interfaces that users love to interact with.' },
    { icon: <Layers className="w-7 h-7" />, title: 'Modern design systems', description: 'Scalable design systems that grow with your product.' },
  ];

  return (
    <section className="uiux-why-section w-full py-32" style={{ backgroundColor: '#F8FAFF' }}>
      <div className="max-w-[1440px] mx-auto px-12">
        <div className="text-center mb-20 space-y-4">
          ...
          <h2 style={{ fontFamily: 'Inter, sans-serif', fontSize: '48px', fontWeight: 700, color: '#151561', letterSpacing: '-0.02em', lineHeight: '1.2' }}>Our Design Excellence</h2>
        </div>
