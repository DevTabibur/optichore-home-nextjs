...
export function WebDevCTA() {
  return (
    <section 
      className="web-dev-cta-section w-full lg:py-32 md:py-18 py-16" 
      style={{ background: 'linear-gradient(135deg, #151561 0%, #1a1a7a 100%)' }}
    >
      {/* ========================================== */}
      ...
      <div className="hidden lg:block max-w-[1440px] mx-auto px-12">
        <div className="text-center space-y-10">
          ...
          >
            ✓ Free consultation · ✓ Modern tech stack · ✓ Scalable solutions
          </div>
        </div>
      </div>
      ...
      <div className="lg:hidden max-w-[1440px] mx-auto md:px-8 px-5">
        <div className="text-center md:space-y-8 space-y-6">
          {/* Heading - Responsive */}
          <h2 
            className="cta-heading-responsive md:text-[44px] text-[32px]" 
            style={{ 
              fontFamily: 'Inter, sans-serif', 
              fontWeight: 700, 
              color: '#FFFFFF', 
          ...
          {/* Subtext - Responsive */}
          <p 
            className="cta-subtext-responsive md:text-[16px] text-[15px]" 
            style={{ 
              fontFamily: 'Inter, sans-serif', 
              fontWeight: 400, 
              color: 'rgba(255, 255, 255, 0.85)', 
          ...
          {/* Trust Badge / Benefits Row - Responsive */}
          <div className="md:pt-5 pt-4">
            {/* Tablet version - horizontal with wrap */}
            <div 
            ...
            <div className="trust-badge-mobile md:hidden flex flex-col items-center gap-2">
              <div 
                style={{ 
                  fontFamily: 'Inter, sans-serif', 
                  fontSize: '13px', 
